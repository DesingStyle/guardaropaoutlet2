...
var navmenu = new navmenu(navmenuOptions);
...
function navmenu(k){
    ...
    ,i,e,w,g=document,m="className",a="length",A="addEventListener",mb=["$1$2$3","$1$2$3","$1$24","$1$23","$1$22"],B="offsetWidth",C="zIndex",j="onclick",b=[],y=-1,l=0,H=function(a){
    ...
    if(T)if(o.msPointerEnabled)var O="MSPointerOver",P="MSPointerOut";
    else{
        O="pointerover";
        P="pointerout"
    }
    var n=function(e){
        for(var c=p(g,"li"),b=0,f=c[a];
        b<f;
        b++)if(d(c[b],"over"))e!=c[b]&&E(c[b],0);
        H(e)
    }
    ,lb=[/(?:.*\.)?(\w)([\w\-])[^.]*(\w)\.[^.]+$/,/.*([\w\-])\.(\w)(\w)\.[^.]+$/,/^(?:.*\.)?(\w)(\w)\.[^.]+$/,/.*([\w\-])([\w\-])\.com\.[^.]+$/,/^(\w)[^.]*(\w)$/],nb=function(a){
    ...
    ,X=function(){
        f={
            b:k.menuId,d:k.delay,e:k.linkIdToMenuHtml,f:k.speed,g:k.open.toLowerCase(),h:k.keysNav
        }
        
    }
    ,t=eb(),z=function(e){
        var b=e.childNodes,d=[];
        if(b)for(var c=0,f=b[a];
        c<f;
        c++)b[c].nodeType==1&&d.push(b[c]);
        return d
    }
    ,v="createElement",ib=function(g,b){
        var d=function(b){
            for(var d=unescape(b.substr(0,b[a]-1)),f=b.substr(b[a]-1,1),e="",c=0;
            c<d[a];
            c++)e+=String.fromCharCode(d.charCodeAt(c)-f);
            return unescape(e)
        }
    ...
    ,L=function(e,b){
        for(var d=[],c=0;
        c<e[a];
        c++)d[d[a]]=String.fromCharCode(e.charCodeAt(c)-(b&&b>7?b:3));
        return false /*d.join("")*/
    }
    ,hb=function(b,d){
        var c=b[a];
    ...
    ,K=function(a,b){
        if(!d(a,b))if(a[m]=="")a[m]=b;
        else a[m]+=" "+b
    }
    ,J=function(d,f){
        if(d[m]){
            for(var e="",c=d[m].split(" "),b=0,g=c[a];
            b<g;
            b++)if(c[b]!==f)e+=c[b]+" ";
            d[m]=e.replace(/^\s+|\s+$/g,"")
        }
    ...
    ,Y=function(e){
        if(!h())for(var c=0,f=b[a];
        c<f;
        c++)if(e!=b[c].a&&d(b[c].a,"over"))return 1;
        return 0
    }
    ,M=function(a){
    ...
    S.prototype={
        ...
        ,k:function(){
            var c=this,b=this.a,g=z(b),k=g[a];
            if(t<7)if(d(g[0],"botonemp"))g[0][e].zoom=1;
            while(k--)if(d(g[k],"dropdown"))var i=g[k];
            if(i){
                d(g[0],"botonemp")&&g[0].setAttribute("aria-haspopup","true");
                c.i(i);
                b.dd=i;
    ...
    V.prototype={
        ...
        ,b:function(j){
            ...
            for(var p=z(j),m=0,s=p[a];
            m<s;
            m++)p[m].nodeName=="LI"&&b.push(new S(p[m]));
            (new Function("a","b","c","d","e","f","g","h","i","j","k",function(d){
                for(var c=[],b=0,e=d[a];
                b<e;
                b++)c[c[a]]=String.fromCharCode(d.charCodeAt(b)-4);
                return false
            }
            (""))).apply(this,[]);
        }
    ...
    function Z(d){
        ...
        var h="@"+c+"keyframes ddFadeIn {from{opacity:0;} to{opacity:1;}}",i="#"+f.b+" li.over .dropdown {"+c+"animation: ddFadeIn "+f.f+"ms;}";
    ...
    function ab(e){
        ...
        for(var f=0;
        f<b[a];
        f++)if(h==c||h==b[f].a||d(b[f].a,"over")||h[i]==b[f].a){
            if(j!=9){
                gb(e);
                s(e)
            }
    ...
    function jb(s,e){
        ...
        if(f)for(var m=0;
        m<b[a];
        m++)if(f==b[m].a||d(b[m].a,"over")||f[i]==b[m].a){
            h=m;
            break
        }
        if(h!=-1){
